          ...
          >
            ...
            <div className="mb-8 relative z-10">
              ...
              <p className="text-sm font-medium text-slate-500">
                Sign in to your Crack404 enterprise workspace
              </p>
            </div>
            ...
            <form className="space-y-5 relative z-10">
              ...
              <div className="flex items-center justify-between text-sm pt-1">
                <label className="flex items-center space-x-2 cursor-pointer group">
                  <input type="checkbox" className="w-4 h-4 rounded border-slate-300 text-orange-600 focus:ring-orange-500/30 cursor-pointer" />
                  <span className="text-slate-600 font-medium group-hover:text-slate-800 transition-colors">Remember me</span>
                </label>
                <Link href="/auth/forgot-password" className="text-orange-600 hover:text-orange-700 font-semibold transition-colors">
                  Forgot password?
                </Link>
              </div>
              ...
              <motion.button 
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full py-3.5 mt-2 rounded-xl bg-gradient-to-r from-orange-600 to-amber-600 text-white font-bold tracking-wide shadow-lg shadow-orange-600/25 hover:shadow-orange-600/40 transition-all duration-300 flex items-center justify-center gap-2"
              >
            ...
            <p className="text-center text-slate-500 text-sm mt-6 font-medium relative z-10">
              ...
              <Link href="/auth/signup" className="text-orange-600 hover:text-orange-700 transition-colors font-semibold">
                Sign up
              </Link>
            </p>
          </motion.div>
